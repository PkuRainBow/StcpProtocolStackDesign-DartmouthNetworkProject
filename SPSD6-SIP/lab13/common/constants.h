...
//传输层参数
/*******************************************************************/
//used to control the print to find the bug ...
//#define Y_DEBUG 1;
...
//SYN_TIMEOUT值, 单位为纳秒
#define SYN_TIMEOUT 800000000
//FIN_TIMEOUT值, 单位为纳秒
#define FIN_TIMEOUT 800000000
...
#define SENDBUF_POLLING_INTERVAL 800000000
...
#define ACCEPT_POLLING_INTERVAL 800000000
//接收缓冲区大小
